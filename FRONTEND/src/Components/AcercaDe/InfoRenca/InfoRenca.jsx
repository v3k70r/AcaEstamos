    ...
    return (
        ...
        <div id="cartasInfo" className="container-fluid" style={{ marginTop: '45px', marginBottom: '45px' }}>
            <div className="row justify-content-center">
                <div className="cartaInfo col-lg-5 text-center" style={{ backgroundColor: '#0492d0', borderRadius: '20px' }}>
                    <h3>Información sobre empleabilidad en Renca</h3>
                </div>
                <div className="cartaInfo col-lg-5 text-center" style={{ backgroundColor: '#E5ECF6', borderRadius: '20px' }}>
                    <p>
