  ...
  return (
    <div className="container justify-content-center">
      <div className="card">
        ...
        <div className="d-flex justify-content-center text-center" style={{ marginTop: "-370px" }}>
          <a href="http://localhost:5173/unbuencurriculum">
            <img src="images/inicioinfobuencv.jpg" className= "card-img-bottom img-fluid" alt="..." />
          </a>
        </div>
      </div>
    </div>
