    ...
    <>
      ...
      <div className="row text-center m-5">
        <div className="col-lg-4">
          <h4 style={{ backgroundColor: "#E5ECF6", borderRadius: "20px" }}>Completa tu perfil</h4>
          <p>Mientras más información proporcionas a tu perfil, mejor podemos conectarte con las oportunidades especiales
            para ti.</p>
        </div>
        <div className="col-lg-4">
          <h4 style={{ backgroundColor: "#E5ECF6", borderRadius: "20px" }}>Busca talentos</h4>
        ...
        <div className="col-lg-4">
          <h4 style={{ backgroundColor: "#E5ECF6", borderRadius: "20px" }}>Consejos de empleabilidad</h4>
