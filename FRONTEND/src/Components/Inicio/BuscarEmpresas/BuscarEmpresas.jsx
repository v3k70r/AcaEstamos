...
function BuscarEmpresas() {
  return (
    <>
      ...
      <div className="text-center m-5" style={{ backgroundColor: "#E5ECF6", borderRadius: "20px", padding:"20px" }}>
        <h4>Búsqueda de empresas asociadas</h4>
        {/* barra de busqueda */}
        <nav className="navbar bg-body-tertiary">
          <div className="container justify-content-center">
            <form className="d-flex card-busquedahome" role="search"  style={{ padding: '10px' }}>
