    ...
    return (
        <div className="card cardF2">
            <div className="card-body cardbodyF2item1">
                <p className="card-text cardtextF2item1" style={{ overflow: 'hidden' }}>
                    ...
                    <div className="rectangulo" style={{ textAlign: 'center' }}>
                        <div className="align-items-center" style={{ display: 'flex', flexDirection: 'column' }}>
                            <button className="boton-tarjeta-cardF2" style={{ padding: '5px', width: '100%', margin: '5px' }}>{interes1}</button>
                            <button className="boton-tarjeta-cardF2" style={{ padding: '5px', width: '100%', margin: '5px' }}>{interes2}</button>
                            <button className="boton-tarjeta-cardF2" style={{ padding: '5px', width: '100%', margin: '5px' }}>{interes3}</button>
                        </div>
                    </div>
                </p>  
            </div>
